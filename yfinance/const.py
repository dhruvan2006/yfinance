...
EQUITY_SCREENER_EQ_MAP = {
    "exchange": {
        ...
        'tr': {'IST'},
        'tw': {'TAI', 'TWO'},
        'us': {'ASE', 'BTS', 'CXI', 'NAE', 'NCM', 'NGM', 'NIM', 'NMS', 'NYQ', 'OEM', 'OQB', 'OQX', 'PCX', 'PNK', 'YHD'},
        've': {'CCS'},
        'vn': {'VSE'},
        'za': {'JNB'}
    },
...
ETF_SCREENER_EQ_MAP = {
    "exchange": EQUITY_SCREENER_EQ_MAP["exchange"].copy(),
    "primary_sector": EQUITY_SCREENER_EQ_MAP["sector"].copy(),
...
ETF_SCREENER_EQ_MAP['region'] = ETF_SCREENER_EQ_MAP['exchange'].keys()
ordered_etf_keys = ['region', 'exchange'] + [k for k in ETF_SCREENER_EQ_MAP.keys() if k not in ['region', 'exchange']]
ETF_SCREENER_EQ_MAP = {k: ETF_SCREENER_EQ_MAP[k] for k in ordered_etf_keys}
